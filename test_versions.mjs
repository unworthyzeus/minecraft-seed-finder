...
const EXPECTED_FILE = '../cubiomes/expected_fixed.txt';
...
async function runTest() {
    ...
    for await (const line of rl) {
        ...
        // C to JS version mapping: JS = C + 9
        const mc = c_mc + 9;
        ...
        try {
            ...
            // C uses scale 4 coordinates, JS getBiome divides by 4
            const got = gen.getBiome(x * 4, z * 4);
