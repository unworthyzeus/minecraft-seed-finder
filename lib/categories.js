...
export const CATEGORIES = {
    ...
    end_portal_missing: {
        ...
        probability: 'Depends on version/glitch',
        color: '#a855f7',
        rarity: 15
    },
    ...
    structure_combo: {
        ...
        probability: 'Varies (~1 in 100M+ for triple)',
        color: '#f59e0b',
        rarity: 9
    },
    spawner_anomaly: {
    ...
    desert_mansion: {
        ...
        probability: 'Extremely Rare (Biome Clash)',
        color: '#d97706',
        rarity: 11
    },
    ...
    tall_cactus: {
        ...
        probability: '4-block: ~1/50 per chunk | 5-block: Rare',
        color: '#22c55e',
        rarity: 6
    },
    tall_sugarcane: {
    ...
    stronghold_spawn: {
        ...
        probability: 'Variable (Dependent on seed/version)',
        color: '#6366f1',
        rarity: 14
    },
    ...
    quad_witch_hut: {
        ...
        probability: '~1 in 160 million seeds',
        color: '#7c3aed',
        rarity: 8
    },
    ...
    historic: {
        ...
        probability: 'Unique / One-of-a-kind',
        color: '#dc2626',
        rarity: 0 // Special
    },
    ...
    speedrun: {
        ...
        probability: 'Hand-picked / Filtered',
        color: '#f97316',
        rarity: 0 // Special
    },
    ...
    sister_structure: {
        id: 'sister_structure',
        name: 'Sister Verified',
        icon: '👯',
        description: 'Seeds sharing verified structure placement (lower 48 bits) with authenticated worlds',
        probability: 'Algorithmically Derived',
        color: '#0ea5e9',
        rarity: 0
    },
