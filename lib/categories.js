...
export const CATEGORIES = {
    ...
    end_portal_12eye: {
        ...
        color: '#8b5cf6',
        rarity: 10 // Still very rare, but scaled relative to others
    },
    end_portal_missing: {
        id: 'end_portal_missing',
        name: 'Broken End Portals',
        icon: '💔',
        description: 'End Portals with missing frames',
    ...
    mob_spawn: {
        ...
        probability: 'Some Rare, Some Very Rare',
        color: '#f472b6',
        rarity: 7
    }
};
...
export const VERSIONS = {
    java: [
        { id: 'java_26.1.2', name: 'Java 26.1.2', released: '2026-04-09' },
    ...
    bedrock: [
        { id: 'bedrock_26.13', name: 'Bedrock 26.13', released: null },
