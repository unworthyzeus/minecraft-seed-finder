...
export function setupLayerStack(mc, largeBiomes = false) {
    ...
    if (mc === MC_B1_8) {
        p = layers.land2048 = new Layer(mapLandB18, 2048, 1, layers.zoom2048);
        p = layers.zoom1024 = new Layer(mapZoom, 1024, 2001, p);
        p = layers.land1024a = new Layer(mapLandB18, 1024, 2, p);
